            ...
            new Area("San Pablo")
                    ...
                    .hotels(
                            new Hotel("Casa San Pablo",
                                    ...
                                    new Offer("Room 1", "Standard Double Room", 3900.),
                                    new Offer("Room 2", "Family Rooms, Triple sharing", 4950.),
                                    new Offer("Room 3", "Twin sharing room", 3900.)),
                            new Hotel("Sulyap Gallery Cafe",
                                    ...
                                    new Offer("Ground level", "2 rooms with Queen Bed and 1 room with Single bed",
                                            2200.),
                                    new Offer("Ground level 2 guest",
                                            "2 rooms with Queen Bed and 1 room with Single bed (two guests)", 3200.),
                                    new Offer("2nd level", "2 rooms both with Queen Bed", 2300.),
                                    new Offer("2nd level 2 guest", "2 rooms both with Queen Bed (two guests)",
                                            3400.)),
                            new Hotel("Ang Tahanan ni Aling Meding", // Information taken from various sites
                                    "Look forward to a terrace, a garden, and dry cleaning/laundry services at Ang Tahanan ni Aling Meding  In addition to a bar and conference space, guests can connect to free in-room WiFi.",
                                    new Offer("Standard", "For two adults", 4168.54)),
            ...
            new Area("Palawan")
                    ...
                    .hotels(
                            ...
                            new Hotel("Canvas Boutique Hotel",
                                    ...
                                    new Offer("Deluxe Twin", "Two queen sized bed", 6000.),
                                    new Offer("Deluxe King", "One king sized bed", 6000.),
                                    new Offer("Premier Twin", "Two queen sized bed", 7000.),
                                    new Offer("Premier King", "One king sized bed", 7000)),
                            ...
                            new Hotel("Microtel",
                                    ...
                                    new Offer("2 Queen Beds",
                                            ...
                                            4000.),
                                    new Offer("2 Queen Beds, Beach View",
                    ...
                    .hotels(
                            new Hotel("Seda Nuvali",
                                    ...
                                    new Offer("Deluxe Room",
                                            ...
                                            8000.),
                                    new Offer("Executive Deluxe",
                                            "Enjoy flexibility from our Best Rate. Includes breakfast and free WiFi",
                                            8500.),
                                    new Offer("Premier Room",
                                            "Enjoy flexibility from our Best Rate. Includes breakfast and free WiFi",
                                            9500.)),
                            new Hotel("Paseo Premiere Hotel",
                                    ...
                                    new Offer("Deluxe Single", "Single bed", 3125.)),
                            new Hotel("Microtel",
                            ...
                            new Hotel("Madie's Place Guest House",
                                    ...
                                    new Offer("Attic Room", "2 single beds", 1447.)))
                    .tourGuides(
            ...
            new Area("Cebu")
                    ...
                    .hotels(
                            ...
                            new Hotel("Marco Polo Plaza",
                                    ...
                                    new Offer("Deluxe Mountain View Room",
                                            ...
                                            3257.85),
                                    new Offer("Deluxe Sea View Room",
                                            ...
                                            3757.85),
                                    new Offer("Premier Mountain View Room",
                                            ...
                                            4557.85),
                                    new Offer("Premier Sea View Room",
                                            "Offers 32 sq m/345 sq ft of newly renovated space designed to fit the needs of international travelers. Can accommodate up to three guests. With built-in bidet and premium bathroom amenities.",
                                            4757.85),
                                    new Offer("Deluxe Suite",
                            ...
                            new Hotel("Red Planet Hotel",
                                    ...
                                    new Offer("Double Room", "One queen-sized signature bed.", 1857.),
                                    new Offer("Twin Room", "Two single signature beds.", 2019.)))
                    .tourGuides(
