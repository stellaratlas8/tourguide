            ...
            new Area("San Pablo")
                    ...
                    .hotels(
                            new Hotel("Casa San Pablo",
                                    ...
                                    new Hotel.Offers("Room 1", "Standard Double Room", 3900.),
                                    new Hotel.Offers("Room 2", "Family Rooms, Triple sharing", 4950.),
                                    new Hotel.Offers("Room 3", "Twin sharing room", 3900.)),
                            new Hotel("Sulyap Gallery Cafe",
                                    ...
                                    new Hotel.Offers("Ground level", "2 rooms with Queen Bed and 1 room with Single bed",
                                            2200.),
                                    new Hotel.Offers("Ground level 2 guest",
                                            "2 rooms with Queen Bed and 1 room with Single bed (two guests)", 3200.),
                                    new Hotel.Offers("2nd level", "2 rooms both with Queen Bed", 2300.),
                                    new Hotel.Offers("2nd level 2 guest", "2 rooms both with Queen Bed (two guests)",
                                            3400.)),
                            new Hotel("Ang Tahanan ni Aling Meding", // Information taken from various sites
                                    ...
                                    new Hotel.Offers("Standard", "For two adults", 4168.54)),
            ...
            new Area("Baguio")
                    ...
                    .hotels(
                            ...
                            new Hotel("City Center Hotel",
                                    ...
                                    new Hotel.Offers("Standard Double",
                                            ...
                                            2300.),
                                    new Hotel.Offers("Standard Twin",
                            ...
                            new Hotel("Hotel Elizabeth Baguio",
                                    ...
                                    new Hotel.Offers("Deluxe Queen",
                                            ...
                                            6000.),
                                    new Hotel.Offers("Deluxe Double",
                                            "Individually and stylishly furnished with one queen sized-bed and is equipped cable TV, telephone, in-room safe, coffee and tea making facilities and other amenities to make your stay enjoyable.",
                                            6000.)),
                            new Hotel("Chalet Baguio",
                                    ...
                                    new Hotel.Offers("Standard Room",
                                    ...
                                    new Hotel.Offers("Superior Room",
                                            ...
                                            3400.),
                                    new Hotel.Offers("Deluxe Room Double",
            ...
            new Area("Palawan")
                    ...
                    .hotels(
                            ...
                            new Hotel("Canvas Boutique Hotel",
                                    ...
                                    new Hotel.Offers("Deluxe Twin", "Two queen sized bed", 6000.),
                                    new Hotel.Offers("Deluxe King", "One king sized bed", 6000.),
                                    new Hotel.Offers("Premier Twin", "Two queen sized bed", 7000.),
                                    new Hotel.Offers("Premier King", "One king sized bed", 7000)),
                            ...
                            new Hotel("Microtel",
                                    ...
                                    new Hotel.Offers("2 Queen Beds",
                                            ...
                                            4000.),
                                    new Hotel.Offers("2 Queen Beds, Beach View",
                            ...
                            new Hotel("Aziza Paradise Hotel",
                                    ...
                                    new Hotel.Offers("Superior Premiere",
                                            ...
                                            5300.),
                                    new Hotel.Offers("Superior Twin",
                    ...
                    .hotels(
                            new Hotel("Seda Nuvali",
                                    ...
                                    new Hotel.Offers("Deluxe Room",
                                            ...
                                            8000.),
                                    new Hotel.Offers("Executive Deluxe",
                                            "Enjoy flexibility from our Best Rate. Includes breakfast and free WiFi",
                                            8500.),
                                    new Hotel.Offers("Premier Room",
                                            "Enjoy flexibility from our Best Rate. Includes breakfast and free WiFi",
                                            9500.)),
                            new Hotel("Paseo Premiere Hotel",
                                    ...
                                    new Hotel.Offers("Deluxe Single", "Single bed", 3125.)),
                            new Hotel("Microtel",
                            ...
                            new Hotel("Madie's Place Guest House", "Strategically situated in Santa Rosa, allowing you access and proximity to local attractions and sights. Don't leave before paying a visit to the famous Rose and Grace Restaurant. Massage and restaurant are among the special facilities that will enhance your stay with on-site convenience. ",
                                    new Hotel.Offers("Attic Room", "2 single beds", 1447.))),
            new Area("Cebu")
                    .spots(
                    ...
                    .hotels(
                            new Hotel("Mad Monkey Cebu City", "Experience the best of the Queen City of the South at Mad Monkey Cebu City! Located close to the best tourist spots in the city, we offer budget-friendly private rooms and dorms with friendly staff and a buzzing social vibe.",
                                    new Hotel.Offers("Standard Double", "This private room sleeps 2 guests in a double bed. Room has air conditioning and an ensuite bathroom with a hot shower.", 1640.),
                                    new Hotel.Offers("Standard Triple", "This private room sleeps 3 guests in a double bed and twin bed. Room has air conditioning and an ensuite bathroom with a hot shower.", 1800.)),
                            new Hotel("Radisson Blu Cebu", "Located in the heart of Cebu City, the Radisson Blu Cebu provides five-star accommodations just minutes from the Mactan Channel and right next to Cebu International Port. Enjoy sweeping views of the channel and the city as well as proximity to cultural attractions and beautiful white-sand beaches.",
                                    new Hotel.Offers("Superior Room", "The perfect home base for a conference or sightseeing, our Superior Room offers you a choice of one king bed or two twin beds, plus all the amenities you need for an effortless stay.", 6580.),
                                    new Hotel.Offers("Junior Suite", "Planning an extended stay in Cebu? More than twice the size of our Superior Rooms, these suites feature a king bed and plenty of space to relax.", 8554.),
                                    new Hotel.Offers("Business Class Room", "Upgrade your corporate visit to Cebu City when you reserve a Business Class Room featuring your choice of a king bed or two twin beds.", 10199.)),
                            new Hotel("Marco Polo Plaza", "Marco Polo Plaza, Cebu is home to some of the award-winning restaurants and food of Cebu. The signature buffet restaurant Cafe Marco is awarded \"Best Premium Buffet\" by Sun.Star Best of Cebu, a news and media company.",
                                    new Hotel.Offers("Deluxe Mountain View Room", "Offer 32 sq m/345 sq ft designed to suit today's international travelers. Has view of the mountains. Can fit up to three guest.", 3257.85),
                                    new Hotel.Offers("Deluxe Sea View Room", "Offers 32 sq m/ 345 sq ft space with a relaxing sea and city view fit for today's international traveler. Can accommodate up to three guests.", 3757.85),
                                    new Hotel.Offers("Premier Mountain View Room", "Offers 32 sq m/345 sq ft of newly renovated space designed to fit the needs of international travelers. Can accommodate up to three guests. With built-in bidet and premium bathroom amenities.", 4557.85),
                                    new Hotel.Offers("Premier Sea View Room", "Offers 32 sq m/345 sq ft of newly renovated space designed to fit the needs of international travelers. Can accommodate up to three guests. With built-in bidet and premium bathroom amenities.", 4757.85),
                                    new Hotel.Offers("Deluxe Suite", "The cheapest suite", 200)),
                            new Hotel("Seda Central Bloc Cebu", "none",
                                    new Hotel.Offers("Small", "The cheapest suite", 200)),
